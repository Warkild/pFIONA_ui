                                            ...
                                            <div className="h-full flex flex-row-reverse pl-5">
                                                {(reagent.name !== 'water') && (
                                                    <a href={`${reagent.id}/delete`}>
                                                        <img src="/static/img/ico/icons8-delete-90.svg" className="w-6 red_icon mr-4" alt="Delete" style={{
                                                            filter: "invert(17%) sepia(64%) saturate(4869%) hue-rotate(351deg) brightness(95%) contrast(88%)"
                                                        }} />
                                                    </a>
                                                )}
                                                <a href={`${reagent.id}/edit`}>
                                                    <img src="/static/img/ico/icons8-edit-384.svg" className="w-6 blue_icon mr-4" alt="Edit" style={{
