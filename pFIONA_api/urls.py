...
urlpatterns = [
    ...
    path('get_only_absorbance_wavelength_monitored_through_time_in_cycle_full_info',
         views.api_get_only_absorbance_wavelength_monitored_through_time_in_cycle_full_info,
         name='api_get_only_absorbance_wavelength_monitored_through_time_in_cycle_full_info'),
