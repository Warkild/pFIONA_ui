...
urlpatterns = [
    ...
    path('is_stop_deploying_in_progress', views.api_is_stop_deploying_in_progress, name='api_is_stop_deploying_in_progress'),
    ...
    path('get_monitored_wavelength_values_in_deployment', views.api_get_monitored_wavelength_values_in_deployment, name='api_get_monitored_wavelength_values_in_deployment'),
